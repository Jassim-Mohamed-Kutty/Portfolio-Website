  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        >
          <p>
            Jassim is an <strong className="text-foreground">Analytics Engineer</strong> with a proven track record of transforming complex data into scalable analytics solutions that drive business decisions. His expertise spans <strong className="text-foreground">Power BI, SQL, Databricks, and Azure</strong>, enabling organizations to unlock actionable insights from enterprise data.
          </p>
          <p>
            With experience across Service Operations, Service Delivery, and Global Services, he has designed and delivered semantic models, curated data products, and scalable data pipelines that power self-service analytics and executive reporting. He has extensive experience integrating and modeling data from enterprise platforms such as <strong className="text-foreground">SAP, Salesforce, and Azure Data Lake Storage</strong> to create trusted, business-ready datasets.
          </p>
          <p>
