      ...
      >
        <div className="flex gap-5 items-start">
          ...
          <div className="flex-1">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-1 whitespace-nowrap">Bachelor of Science in Mathematics, Statistics & Economics</h3>
            <p className="text-muted-foreground mb-4">St. Joseph's College, Bengaluru</p>
            <div className="flex flex-nowrap gap-2">
              {["Mathematics", "Statistics", "Economics"].map((m) => (
                <span key={m} className="text-xs font-medium rounded-lg px-3 py-1.5 bg-surface/60 border border-glass-border text-foreground whitespace-nowrap">
                  {m}
                </span>
              ))}
            </div>
